...
public class App {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Produto produto1 = new Produto(1, "Ninho para Bebê Redutor",
				"Com a suavidade do tecido 100% algodão e enchimento fofinho", "./images/ninho.png", pessoa1, cat1);
		Produto produto2 = new Produto(2, "Berço Minicama 3 em 1 Dom",
				...
				"./images/berço.png", pessoa2, cat2);
		Produto produto3 = new Produto(3, "Andador Goal Walker 4 em 1 Cosco",
				"Com a suavidade do tecido 100% algodão e enchimento fofinho", "./images/andardor.png", pessoa3, cat2);
		...
		Produto produto6 = new Produto(6, "Kit Berço Trança Poá Azul Bebê",
				...
				"./images/kitberco.png", pessoa6, cat5);
