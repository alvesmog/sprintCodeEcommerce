...
public class InterfaceSubMenuVenda {
	...
	private static Integer mostrarSubMenuVendas(Scanner input) {
	...
	public static void ingressaOpcoesParaVenda(
		...
		do {
			// Mostra o menu de opções para lidar com as Vendas:
			opcaoEscolhida =  mostrarSubMenuVendas(input);
			Integer inputCarrinho;
			...
			case 5 : // 5. COLOCAR NO CARRINHO DE COMPRAS
				...
				do {
					...
					mostrarCalculosPreliminares(carrinhoDeCompras);
			...
			case 6 : // 6. RETIRAR DO CARRINHO DE COMPRAS
				...
				do {
					...
					Anuncio procuradoParaRemover = procurarNoCarrinhoPorId(carrinhoDeCompras, inputCarrinho);
			...
			case 7: // 7. REALIZAR CHECKOUT
				...
				Financeiro calculosCheckout = mostrarCalculosPreliminares(carrinhoDeCompras);
				boolean repeat = true;
			...
			case 8: // 8. VISUALIZAR PEDIDOS
				...
				case 1:
					...
					mostrarHistoricoPedidos(listaDeVendas);
					System.out.println("\n > Produtos comprados:");
	...
	private static Anuncio procurarNoCarrinhoPorId(List<Anuncio> carrinho, Integer id) {
	...
	private static void mostrarCarrinho(List<Anuncio> carrinho) {
	...
	private static Financeiro mostrarCalculosPreliminares(List<Anuncio> carrinho) {
	...
	private static void mostrarHistoricoPedidos(List<Venda> vendas) {
		if (vendas == null) {
